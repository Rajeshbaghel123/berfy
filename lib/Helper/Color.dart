...
extension colors on ColorScheme {
  ...
  // static const Color primary = Color(0xff406595);
  static const Color primary = Color(0xff000000);
  static const Color primary_sec = Color.fromARGB(32, 212, 175, 55);
  
  static const Color secondary = Color(0xffF0F0F0);

  Color get btnColor => brightness == Brightness.dark ? whiteTemp : primary;

  Color get lightWhite => brightness == Brightness.dark ? darkColor : const Color(0xffF6F6F6);

  Color get fontColor => brightness == Brightness.dark ? whiteTemp : const Color(0xff212121);
  ...
  static const Color darkColor2 = Color(0xff111111);
  ...
  Color get customwhite =>
      brightness == Brightness.dark ? const Color(0xffFFFFFF) : primary;
  ...
  static const Color blackTemp = Color(0xffffffff);
