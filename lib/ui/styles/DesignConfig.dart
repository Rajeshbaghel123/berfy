...
Widget networkImageCommon(String image, double placeHeight, bool isSlider,
  ...
  return Container(
    ...
    child:
        // image.contains(".gif") ?
        //   Image.network(
        //       image, // Replace this with your actual GIF URL
        //       height: height ?? height,
        //       width: width ?? width,
...
Widget networkImageCommon_without_bg(
    String image, double placeHeight, bool isSlider,
    {double? height, double? width, BoxFit? boxFit}) {
  return Container(
    height: height ?? height,
    width: width ?? width,
...
getThemeColor(BuildContext context) {
  ...
  if (systemBrightness == Brightness.dark &&
    ...
    return 'assets/images/splashlogo.png';
...
imagePlaceHolder(double size, BuildContext context) {
  return SizedBox(
    ...
    child: Icon(
      Icons.account_circle,
      color: Theme.of(context).colorScheme.customwhite,
      size: size,
    ),
  );
}
...
String? getPriceFormat(BuildContext context, double price) {
  return "₹${price.toStringAsFixed(0)}"; //"₹$price";
...
String? getPriceFormat_0(BuildContext context, double price) {
