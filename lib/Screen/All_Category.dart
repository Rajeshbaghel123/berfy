              ...
              child: catList.isNotEmpty
                  ? Column(
                      children: [
                        ...
                        //           //           vertical: 8.0),
                        //           //       child: Text(capitalize(catList[data].name!.toLowerCase()),
    ...
    return Selector<CategoryProvider, int>(
      builder: (context, data, child) {
        if (index == 0 && (popularList.isNotEmpty)) {
          ...
          //                 left: BorderSide(width: 2.0, color: colors.primary),
          //               )
          //             : null),
          //     child: Column(
          ...
          //             width: deviceWidth! / 4,
          //             decoration: BoxDecoration(
          //               color: colors.primary_sec,
          //               shape: BoxShape.circle,
          //               border: Border.all(color: colors.primary_app,width: 2.0),
          //               boxShadow: [
          //                 BoxShadow(
          //                   color: Theme.of(context)
          //                       .colorScheme
