...
import 'package:berfy/Screen/PaypalWebviewActivity.dart';
import 'package:berfy/Screen/instamojo_webview.dart';
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      color: withdTranList[index].status == "0"
                          ? Colors.yellow.shade400
                          : withdTranList[index].status == "1"
                              ? Colors.green.shade400
                              : withdTranList[index].status == "2"
                                  ? Colors.red
                                  : Colors.white,
                      child: Text(withdTranList[index].status == "0"
                          ? "Pending"
                          : withdTranList[index].status == "1"
                              ? "Approved"
                              : withdTranList[index].status == "2"
