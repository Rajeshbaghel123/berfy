import 'dart:async';
import 'dart:io';
import 'package:berfy/Screen/Set_Password.dart';
...
import 'package:berfy/Screen/SignUp.dart';
    ...
    if (code.length == 6) {
      ...
      if (isFirebaseAuth!) {
        ...
        var response = await apiBaseHelper.postAPICall(
            getVerifyUserApi, {"mobile": widget.mobileNumber, "otp": code});
          ...
          InkWell(
              onTap: () async {
                ...
                if (isFirebaseAuth == true) {
                  ...
                  var response = await apiBaseHelper.postAPICall(
                      getResendOTPApi, {"mobile": "${widget.mobileNumber}"});
